        ...
        <div className="">
          <div className="absolute left-36 top-24 z-20 flex max-w-[500px] flex-col gap-3">
            ...
            <p className="text-base font-normal">
              Dark Atlas is an AI-powered eXtended Cyber Intelligence (XCI) Platform that protects
              you against cyber threats with actionable &amp; contextualized intelligence.
            </p>
          </div>
          <img
